...
export class SharedService{
    ...
    // private phpServiceURL;
    constructor(private http:Http){
        this.serviceEndPoint = Constant.serverURL;
        // this.phpServiceURL = Constant.phpServiceURL;
    }
    ...
    getPendingOrderByEmpId(jsonData: any) {
        ...
        // return this.http.post(this.phpServiceURL+'getPendingOrderByEmpId.php', dataJson)
        //        .map((response:Response) => response.json()) 
        //        .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    getNonVisitedDealerListByEmpId(jsonData: any) {
        ...
        // let dataJson = JSON.stringify(jsonData);
        // return this.http.post(this.phpServiceURL+'getNonVisitedDealerListByEmpId.php', dataJson)
        //        .map((response:Response) => response.json()) 
        //        .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
