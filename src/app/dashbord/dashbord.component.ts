...
export class DashbordComponent implements OnInit {
  ...
  public getTerritoryCodeByEmpId(){
    ...
    .subscribe(
      (response) => {
        ...
        this.empTerritoryCodeList = CommonFunction.createCommaSeprate(this.territoryCodeList);
        let isSyncButtonShow = response.wrappedList[0].isSyncButtonShow;
        if(isSyncButtonShow == "Y"){
  ...
  public getPerformanceByEmpId(){
    ...
    let jsonData = {
      empId : this.empId,
      period : this.period,
      // empTerritoryCodeList : this.empTerritoryCodeList,
